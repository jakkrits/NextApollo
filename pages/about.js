  ...
  <App>
    ...
    <section className="section is-small">
      <article>
        ...
        <p>
          In this simple example, we integrate Apollo seamlessly with <a href="https://github.com/zeit/next.js">Next</a> by wrapping our pages inside a <a href="https://facebook.github.io/react/docs/higher-order-components.html">higher-order component (HOC)</a>. Using the HOC pattern we are able to pass down a central store of query result data created by Apollo into our React component hierarchy defined inside each page of our Next application.
        </p>
        <p>
